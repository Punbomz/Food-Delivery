        ...
        <div className="flex gap-10 justify-center text-2xl">
          <div className="flex-1/4 hidden lg:flex shadow-lg rounded-box p-10 text-center bg-white">
            <ul className="space-y-10">
              <li onClick={() => setMenu("Order")} className={`rounded-box btn btn-ghost btn-block btn-lg w-full ${menu === "Order" ? "btn-active text-white btn-success" : "" }`}>คำสั่งซื้อ</li>
              <li onClick={() => setMenu("Menu")} className={`rounded-box btn btn-ghost btn-block btn-lg w-full ${menu === "Menu" ? "btn-active text-white btn-success" : "" }`}>รายการอาหาร</li>
              <li onClick={() => setMenu("Profile")} className={`rounded-box btn btn-ghost btn-block btn-lg w-full ${menu === "Profile" ? "btn-active text-white btn-success" : "" }`}>โปรไฟล์</li>
              <li onClick={() => setMenu("Report")} className={`rounded-box btn btn-ghost btn-block btn-lg w-full ${menu === "Report" ? "btn-active text-white btn-success" : "" }`}>ยอดขาย</li>
            </ul>
          </div>
                  ...
                  <div className="mt-2 flex items-center justify-center">
                    <fieldset className="fieldset w-full">
                      ...
                      <div className="space-y-2 w-xs mx-auto">
                        ...
                        <div>
                          <input value={user?.shopPhone || ""} type="text" className="input w-full" placeholder="ระบุเบอร์โทร" required disabled={!isEditing} />
                        </div>
                      </div>
                      <div className="space-y-2 w-xs mx-auto">
