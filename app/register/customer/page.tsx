...
export default function customerRegister() {
  ...
  async function handleRegister(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (res.status === 409) {
      ...
      showAlert("สมัครสมาชิกสำเร็จ!", "/login/customer");
    } else {
            ...
            <form className="justify-center" onSubmit={handleRegister}>
              ...
              <div className="block lg:flex lg:gap-5 justify-between">
                <div className="lg:w-1/2">
                  {/* Email */}
                  <label className="block text-sm text-black mb-1 mt-5">
                    Email มหาวิทยาลัย<p className="text-red-500 inline">*</p>
                  </label>
              ...
              <div className="flex justify-center gap-5 text-sm p-5 w-xs mx-auto">
                <p>มีบัญชีแล้ว?</p>
                <Link href="/login/customer" className="underline text-black hover:text-gray-600">
                  เข้าสู่ระบบ
                </Link>
              </div>
