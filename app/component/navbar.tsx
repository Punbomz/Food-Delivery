                ...
                <div className="navbar bg-[#9EFFAA] w-full pl-10 pr-10 shadow-sm">
                    ...
                    <div className="flex-none lg:hidden">
                        ...
                        <svg width="43" height="50" viewBox="0 0 43 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.375 10.417H5.39292M5.375 25.0003H5.39292M5.375 39.5837H5.39292M14.3333 10.417H37.625M14.3333 25.0003H37.625M14.3333 39.5837H37.625" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        </label>
                    </div>
                ...
                {/* Sidebar */}
                    ...
                    <li>
                        ...
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="httwww.w3.org/2000/svg">
                            <path d="M11.2083 21.4167L18.5 14.125M18.5 14.125L11.2083 6.83333M18.5 14.125H1M18.5 1H24.3333C25.1069 1 25.8487 1.30729 26.3957 1.85427C26.9427 2.40125 27.25 3.14312 27.25 3.91667V24.3333C27.25 25.1069 26.9427 25.8487 26.3957 26.3957C25.8487 26.9427 25.1069 27.25 24.3333 27.25H18.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Login</Link>
                    </li>
                </ul>
